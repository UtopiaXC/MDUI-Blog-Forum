...
public class BeanArticleComment {
    ...
    public BeanArticleComment(String article_comment_id, String article_comment_article_id, String article_comment_user_id, String article_comment_father_user_id, String article_comment_time) {
